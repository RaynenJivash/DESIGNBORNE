 ...
 * Modified by:
 * @author Sarviin Hari u
 */
public class FancyMessage {
    /**
     * The title message for the game.
     */
    ...
    /**
     * The message displayed when the player character dies in the game.
     */
    ...
    /**
     * The message displayed when the Forest Watcher character dies in the game.
     */
    public static String FOREST_WATCHER_DIED =
//            "╔═══════════════════════════╗\n" +
//            "║    FOREST WATCHER DIED    ║\n" +
//            "╚═══════════════════════════╝";
            "      db      `7MM\"\"\"Yp, `YMM'   `MP' `7MM\"\"\"YMM  `7MM\"\"\"Mq.`7MMF'   `7MF'`YMM'   `MM'`7MM\"\"\"YMM  `7MM\"\"\"Mq.      `7MM\"\"\"Yb. `7MMF'`7MM\"\"\"YMM  `7MM\"\"\"Yb.\n" +
            "     ;MM:       MM    Yb   VMb.  ,P     MM    `7    MM   `MM. `MA     ,V    VMA   ,V    MM    `7    MM   `MM.       MM    `Yb. MM    MM    `7    MM    `Yb.\n" +
            "    ,V^MM.      MM    dP    `MM.M'      MM   d      MM   ,M9   VM:   ,V      VMA ,V     MM   d      MM   ,M9        MM     `Mb MM    MM   d      MM     `Mb\n" +
            "   ,M  `MM      MM\"\"\"bg.      MMb       MMmmMM      MMmmdM9     MM.  M'       VMMP      MMmmMM      MMmmdM9         MM      MM MM    MMmmMM      MM      MM \n" +
            "   AbmmmqMA     MM    `Y    ,M'`Mb.     MM   Y  ,   MM  YM.     `MM A'         MM       MM   Y  ,   MM  YM.         MM     ,MP MM    MM   Y  ,   MM     ,MP \n" +
            "  A'     VML    MM    ,9   ,P   `MM.    MM     ,M   MM   `Mb.    :MM;          MM       MM     ,M   MM   `Mb.       MM    ,dP' MM    MM     ,M   MM    ,dP' \n" +
            ".AMA.   .AMMA..JMMmmmd9  .MM:.  .:MMa..JMMmmmmMMM .JMML. .JMM.    VF         .JMML.   .JMMmmmmMMM .JMML. .JMM.    .JMMmmmdP' .JMML..JMMmmmmMMM .JMMmmmdP'   \n";
}
